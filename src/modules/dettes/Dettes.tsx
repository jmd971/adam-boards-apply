      ...
      <div style={{ padding: '20px 24px', maxWidth: 1280, margin: '0 auto' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(5, 1fr)', gap: 10, marginBottom: 20 }}>
          <div style={{ background: '#0f172a', borderRadius: 12, padding: '14px 16px', border: '1px solid rgba(255,255,255,0.06)', gridColumn: 'span 1' }}>
            <div style={{ fontSize: 9, fontWeight: 700, color: '#94a3b8', textTransform: 'uppercase', letterSpacing: '0.6px', marginBottom: 6 }}>Total dettes</div>
            <div style={{ fontSize: 24, fontWeight: 800, fontFamily: 'monospace', color: '#f59e0b' }}>{fmt(totalCreances)} €</div>
            <div style={{ fontSize: 10, color: '#334155', marginTop: 4 }}>{nbTotal} fournisseur{nbTotal > 1 ? 's' : ''}</div>
          </div>
          <div style={{ background: '#0f172a', borderRadius: 12, padding: '14px 16px', border: '1px solid rgba(255,255,255,0.06)' }}>
            <div style={{ fontSize: 9, fontWeight: 700, color: '#94a3b8', textTransform: 'uppercase', letterSpacing: '0.6px', marginBottom: 6 }}>DPO (délai moyen)</div>
            <div style={{ fontSize: 24, fontWeight: 800, fontFamily: 'monospace', color: dso ? (dso > 60 ? '#ef4444' : dso > 30 ? '#f59e0b' : '#10b981') : '#94a3b8' }}>
              {dso !== null ? `${dso} j` : '—'}
            </div>
            <div style={{ fontSize: 10, color: '#334155', marginTop: 4 }}>Délai moyen de paiement</div>
          </div>
          ...
          <div style={{ background: '#0f172a', borderRadius: 12, padding: '14px 16px', border: '1px solid rgba(59,130,246,0.15)' }}>
            ...
            <div style={{ fontSize: 10, color: '#334155', marginTop: 4 }}>{byBucket[3].length} fournisseur{byBucket[3].length > 1 ? 's' : ''}</div>
          </div>
          <div style={{ background: '#0f172a', borderRadius: 12, padding: '14px 16px', border: '1px solid rgba(34,197,94,0.15)' }}>
            ...
            <div style={{ fontSize: 10, color: '#334155', marginTop: 4 }}>{byBucket[4].length} fournisseur{byBucket[4].length > 1 ? 's' : ''}</div>
          </div>
        </div>
